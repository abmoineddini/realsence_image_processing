...
if not os.path.exists('./data_all'):
    os.mkdir('data_all')
    print("Data not found! please include the images and lables in this directory")
else:
    print("lets start")
    # adjust here:
    Tennis_ball_id = '/m/05ctyq'  # Tennis ball: '/m/05ctyq', alpacha: '/m/0pcr', 
    class_names =  'tennis_ball'  # Name of the class
